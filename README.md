# Hey There Future Ultra Team Members!

We forked this repository because sometimes GitHub is down.

When GitHub is down and we try to upload an asset after a long workflow file. It will fail.

The changes that were done to this forked version fix this by retrying a handful of times.

The PR for the main repository was created but never merged because they think octokit will solve all their problems. 🙈

Good thing we have this solution right here.

[Original PR that never got merged for god knows what reason](https://github.com/softprops/action-gh-release/pull/181)
