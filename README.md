...
| `retries`                  | Number  | The amount of retries you want if uploading an asset fails. This will default to 0 which means none.                                                                                                                                                                                                                                                                                        |
| `retry_interval`           | Number  | The interval in millisecond between failed asset upload attempts.                                                                                                                                                                                                                                                                                                                           |
| `delete_on_existing`       | Boolean | Whether or not to delete an existing release's assets entirely when running this action.                                                                                                                                                                                                                                                                                                    |
